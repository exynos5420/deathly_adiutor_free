...
import com.exynos5420.deathlyadiutor.ads.fragments.PathReaderFragment;
import com.exynos5420.deathlyadiutor.ads.fragments.RecyclerViewFragment;
import com.exynos5420.deathlyadiutor.ads.fragments.ViewPagerFragment;
import com.exynos5420.deathlyadiutor.ads.utils.Constants;
import com.exynos5420.deathlyadiutor.ads.utils.Utils;
import com.exynos5420.deathlyadiutor.ads.utils.kernel.CPU;
...
public class CPUFragment extends ViewPagerFragment implements Constants {
    ...
    public static class CPUPart extends RecyclerViewFragment implements View.OnClickListener,
                                ...
                                public void run() {
                                    if (usage != null) {
                                        ...
                                        if (mCoreUsageText != null) {
                                            List<Integer> cores = CPU.getCoreRange();
        ...
        private void coreInit() {
            ...
            mCoreCheckBox = new AppCompatCheckBox[CPU.getCoreRange().size()];
        ...
        public void onClick(View v) {
            for (int i = 0; i < mCoreCheckBox.length; i++)
                if (v == mCoreCheckBox[i]) {
                    List<Integer> range = CPU.getCoreRange();
                    if (range.get(i) == 0) {
    ...
    public static class GovernorPart extends PathReaderFragment {
        ...
        public String getName() {
                return CPU.getCurGovernor();
        }

        @Override
        public String getPath() {
            return getPath(CPU_GOVERNOR_TUNABLES, CPU.getCurGovernor());
        }
        ...
        public String getError(Context context) {
                return context.getString(R.string.not_tunable, CPU.getCurGovernor());
        }
    }
}

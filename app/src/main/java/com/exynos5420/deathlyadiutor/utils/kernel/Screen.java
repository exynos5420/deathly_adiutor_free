...
import com.exynos5420.deathlyadiutor.services.HBMWidget;
import com.exynos5420.deathlyadiutor.utils.Constants;
import com.exynos5420.deathlyadiutor.utils.Utils;
import com.exynos5420.deathlyadiutor.utils.json.GammaProfiles;
...
public class Screen implements Constants {
    ...
    public static void activateScreenHBM(boolean active, Context context, String source) {
        if (source.equals("Manual")) {
            AutoHighBrightnessModeService.HBM_Manually_Toggled = !(Screen.isScreenAutoHBMActive(context) && AutoHighBrightnessModeService.HBM_Manually_Toggled);
        }
